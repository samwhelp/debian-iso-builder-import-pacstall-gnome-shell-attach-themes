...
REF_WORK_DIR_PATH="${HOME}/work/debian-iso-builder-import-pacstall-gnome-shell-attach-themes"
...
echo "[Next Step]: cd ~/work/debian-iso-builder-import-pacstall-gnome-shell-attach-themes/iso-profile
"
echo
